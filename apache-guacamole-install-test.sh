...
#Server URL
SERVER="http://apache.org/dyn/closer.cgi?action=download&filename=guacamole/${GUACVER}"

wget -O guacamole-server-${GUACVER}.tar.gz ${SERVER}/usr/src/guacamole-server-${GUACVER}.tar.gz
